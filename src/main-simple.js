  ...
  try {
    ...
    if (isFirstRun) {
      ...
      try {
        ...
        console.log('[MAIN] No Google tokens to clear (expected on first run)');
      }
      ...
      try {
        ...
        console.log('[MAIN] No Notion tokens to clear (expected on first run)');
      }
      ...
      console.log('[MAIN] Existing installation detected - tokens will be restored from system keychain');
    }
  } catch (error) {
...
function createWindow() {
  ...
  mainWindow.on('close', (event) => {
    console.log('[MAIN] CLOSE EVENT FIRED');
